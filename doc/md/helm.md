...
Our coroutine nests will pass yields which are \(hopefully\) intended to be
resumed on a later tick\.

I'm going to pass in `dispatch_input` rather than forward reference it, this
isn't the final form of this I'm fairly sure\.

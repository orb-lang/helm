...
-  wrappable  : Is it acceptable to wrap this token by breaking it
                in the middle, or must it be moved entirely to the next line
                if it does not fit? If true, the following will also exist:
